...
class LevelDBTransaction : public Transaction {
 public:
  ...
  virtual bool UpdateValue(const string& key, const string &old_value, const string& new_value)
  {
    return true;
  }
 private:
